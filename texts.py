...
WELCOME_TEXT_USER = """
Привет! Напиши сообщение и в скором времени один из операторов тебе ответит.

Что нужно от тебя для успешного рефанда:

- Номер телефона/Почта/QR код 
- Код для входа
- Оплата заказа по карте
- Хорошо прогретый аккаунт
- Фотографии некоторых позиций из твоего заказа

Оператор зайдёт на аккаунт и выполнит все свои действия, после успешного возврата средств оператор выйдет с твоего аккаунта. 

Оплата производится сразу же после успешного выполнения наших услуг. Комиссия составляет - 20% от суммы заказа. 

Пример: заказ еды на 2.500 рублей, комиссия за нашу работу составит 500 рублей, то есть по факту ты получишь еды на 2.500 рублей, но за 500 рублей.
"""
